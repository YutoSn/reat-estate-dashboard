...
METRIC_SPECS: list[MetricSpec] = [
    ...
    # 乳幼児期にいちばん通うのは小児科。全診療科をまとめた医師数では、
    # 「近くに小児科があるか」という肝心の点が見えない。
    MetricSpec(
        "pediatric_clinics_catchment", "小児科の密度（15km圏）", True, "medical",
        "半径15km圏で小児科を標榜する医療機関の数を、同じ圏内の15歳未満人口で"
        "割った値。分母を子どもの数にしているので、高齢化した街が有利に"
        "ならない。",
        unit="施設/子ども1万人",
        formula="Σ(15km圏内の小児科標榜施設) ÷ Σ(15km圏内の15歳未満人口) × 10000",
    ),
    MetricSpec(
        "obstetric_clinics_catchment", "産科の密度（15km圏）", True, "medical",
        "半径15km圏で産科・産婦人科を標榜する医療機関の数。"
        "第二子以降を考えるときの受け皿。婦人科のみの施設は含めない。",
        unit="施設/万人",
        formula="Σ(15km圏内の産科標榜施設) ÷ Σ(15km圏内の人口) × 10000",
    ),
